              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Icon(Iconsax.diamonds, color: easyColors.primaryColor),
                  ],
                ),
              ),
            ),
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: GridView.builder(
                                ...
                                itemCount: 4,
                                itemBuilder: (context, i) {
                                  final products = service.datumProdutos.data[i];
                                  return ClipRRect(
                  ...
                  Stack(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          IconButton(
                            icon: const Icon(Ionicons.home, size: 25),
                            onPressed: () {
                              Navigator.pushNamed(context, '/login');
                            },
                            color: Colors.white,
                  ...
                  Stack(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          IconButton(
                            icon: const Icon(Ionicons.search, size: 25),
                            onPressed: () {
                              Navigator.pushNamed(context, '/login');
                            },
                            color: Colors.white,
                  ...
                  Stack(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          IconButton(
                            icon: const Icon(Ionicons.settings, size: 25),
                            onPressed: () {
                              Navigator.pushNamed(context, '/login');
                            },
                            color: Colors.white,
